...
| Остальной интернет | WG **MacBook** (публичный выход как у пира, сейчас `77.246.99.98`) |
| Endpoint MacBook и Home (`77…:51820`, `94.41.85.180:51820`) | Физический шлюз, без петли |
| Локальная LAN `192.168.3.0/24` | Wi‑Fi |
