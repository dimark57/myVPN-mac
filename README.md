...
С **0.5.8** в менюбаре один процесс (`SingleInstance`): второй `open` / DerivedData уступает `~/Applications`. Не открывай stage/`DerivedData/.../Release/myVPN.app` рядом с живым UI.
